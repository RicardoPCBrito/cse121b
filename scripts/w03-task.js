...
document.getElementById('array').innerHTML = "Source Array: " + numbersArray
...
let doubleArray = document.getElementById('multiplied').innerHTML = numbersArray.map(number => number * 2)
document.getElementById('sumOfMultiplied').innerHTML = doubleArray.reduce((sum, number) => sum + number)
